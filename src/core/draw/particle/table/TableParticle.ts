...
export class TableParticle {
  ...
  private _drawBorder(
    ...
    for (const drawTd of drawTdList) {
      ...
      if (td.slashTypes?.length) {
        this._drawSlash(ctx2d, drawTd, startX, startY)
      }
  ...
  public render(
    ...
    this._drawBackgroundColor(ctx2d, startX, startY, drawTdList)
    this._drawBorder(ctx2d, element, startX, startY, drawTdList, fragment)
  }
}
